...
MASS_FILE = os.path.join(DATA_DIR, 'mass.mas16')
ABUN_FILE = os.path.join(DATA_DIR, 'abundances.txt')
...
def generate_header():
    ...
    header_file += "/// /file mass_abundance_data.h\n"
    header_file += "/// /author Andrew Davis (@makeclean)\n"
    header_file += "///\n"
...
def main(args=()):
    ...
    source = generate_cpp()
    write_if_diff("mass_abundance_data.h", header)
    write_if_diff("mass_abundance_data.cpp", source)
